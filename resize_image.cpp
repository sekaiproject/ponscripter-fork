...
static void calcWeightedSumColumnInit(unsigned char** src, int interpolation_height, int image_width, int image_height, int image_pixel_width, int byte_per_pixel)
{
...
static void calcWeightedSumColumn(unsigned char** src, int y, int interpolation_height, int image_width, int image_height, int image_pixel_width, int byte_per_pixel)
{
...
static void calcWeightedSum(unsigned char** dst, unsigned char** src, int x, int interpolation_width, int image_width, int byte_per_pixel)
{
